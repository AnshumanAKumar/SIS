...
<tr>
        ...
        <br>
        <input type="submit" name="submit" value="ADD" id="myButton"/>
</form>
</body>
</html>
...
if(isset($_POST['submit']))
 ...
 $q1=mysqli_query($conn,"insert into bhup values('$cap1','$cap2','$session','$rn','$branch','$year','$semester','$dd $mm $yy','$cap3')");
if($q1)
{
 echo "  <br/> <div class='font'> <font color = 'white' > Record Successfully Add  </font> <div>";
}
else
{
echo" <br/><div class='font'> <font color = 'white' > ROLL NO- $rn  , BRANCH- $branch ,& YEAR- $year  already exist. Please delete or update as required </font> <div>" ;
}
 }
?>